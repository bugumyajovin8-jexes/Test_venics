...
import { useIsScreenTakeover } from '../utils/screenTakeover';
...
export default function NotificationCenter() {
  ...
  // Ripoti za Wafanyakazi is not a route — it is rendered inside
  // ExecutiveDashboard while the URL stays on /executive — so `location` alone
  // cannot see it, and this fixed bell was landing on top of that screen's own
  // header control, the permissions gear.
  const screenTaken = useIsScreenTakeover();
