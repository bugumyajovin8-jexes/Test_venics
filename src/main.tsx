...
async function bootstrap() {
  ...
  // Read-only enforcement is a Dexie middleware, and Dexie only applies
  // middleware registered before the connection opens. Install it before App is
  // imported, since App's module graph touches the database immediately.
  const { installReadOnlyGuard } = await import('./services/readOnly');
